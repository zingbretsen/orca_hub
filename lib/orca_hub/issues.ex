defmodule OrcaHub.Issues do
  ...
  `file_feature_request` MCP tool — create, fetch, list-open-for-project,
  and append a note. No project/session association management, no
  closing/reopening workflow — that's UI territory that stays removed.
  """
