defmodule OrcaHubWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OrcaHubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OrcaHubWeb.Gettext, "errors", msg, opts)
    end
  end
